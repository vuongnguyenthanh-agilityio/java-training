...
public class CustomResponseException extends ResponseEntityExceptionHandler {
  ...
  @ExceptionHandler(CurrencyExchangeException.NotFoundException.class)
  ...
  @ExceptionHandler(CurrencyExchangeException.BadRequestException.class)
  ...
  @ExceptionHandler(CurrencyExchangeException.UnauthorizedException.class)
